...
-->
<template>
  <div class="form-create-designer-header__wrapper">
    <div class="form-create-designer-header__wrapper__left">
      <img src="@/assets/images/form-create-logo.png">
...
<style lang="scss">
@import "./form-create-designer-header.scss";
</style>